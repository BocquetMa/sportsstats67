...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Évolution - Graphiques et tracking
    Route::get('/evolution', [EvolutionController::class, 'index'])->name('evolution.index');
    Route::get('/evolution/body-metrics', [EvolutionController::class, 'bodyMetricsChart'])->name('evolution.body-metrics');
    Route::post('/evolution/body-metric', [EvolutionController::class, 'storeBodyMetric'])->name('evolution.body-metric.store');
    Route::get('/evolution/1rm', [EvolutionController::class, 'oneRepMax'])->name('evolution.1rm');
    Route::get('/evolution/progress', [EvolutionController::class, 'exerciseProgress'])->name('evolution.progress');
    Route::get('/evolution/photos', [EvolutionController::class, 'photosTimeline'])->name('evolution.photos');
    Route::post('/evolution/photos', [EvolutionController::class, 'uploadPhoto'])->name('evolution.photos.upload');
    Route::delete('/evolution/photos/{photo}', [EvolutionController::class, 'deletePhoto'])->name('evolution.photos.delete');
    Route::get('/evolution/calories', [EvolutionController::class, 'caloriesBurned'])->name('evolution.calories');
    Route::post('/evolution/calories', [EvolutionController::class, 'storeCalories'])->name('evolution.calories.store');
    Route::get('/evolution/monthly-calories', [EvolutionController::class, 'monthlyCalories'])->name('evolution.monthly-calories');
    Route::get('/evolution/personal-bests', [EvolutionController::class, 'personalBests'])->name('evolution.personal-bests');
